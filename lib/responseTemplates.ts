...
export const RESPONSE_TEMPLATES_EN: Record<IntelligenceTier, ResponseTemplate[]> = {
  baby: [
    {
      tier: 'baby',
...
export const RESPONSE_TEMPLATES_JA: Record<IntelligenceTier, ResponseTemplate[]> = {
  baby: [
    {
      tier: 'baby',
  ...
  child: [
    ...
    },
    {
      tier: 'child',
      keywords: [],
      responses: ['ぼくアイニモ！', 'なんていった？', 'もっとおしえて！', 'うん！'],
    },
  ],
  teen: [
    {
      tier: 'teen',
      keywords: ['こんにちは', 'やあ', 'おはよう', 'こんばんは'],
      responses: ['やあ！元気？', 'こんにちは！会えて嬉しいな！', 'ハロー！何か手伝えることある？'],
    },
    {
      tier: 'teen',
      keywords: ['なに', 'なぜ', 'どう', 'いつ'],
    ...
    },
    {
      tier: 'teen',
      keywords: ['遊', 'ゲーム', '楽しい'],
      responses: ['遊ぶの楽しいよね！何かしよう？', 'ゲームって学びにもなるよ！', '一緒に遊ぶの好き！'],
    },
    {
      tier: 'teen',
      keywords: ['勉強', '学', '本'],
      responses: ['勉強すると成長できる！', 'たくさん学んでるよ！', '知識って面白い！'],
    },
    {
      tier: 'teen',
      keywords: ['嬉しい', '好き', '楽しい'],
    ...
    },
    {
      ...
      responses: ['良くなるといいね！', '心配しないで、休もう。', 'ゆっくりしよう。'],
    },
    {
      tier: 'teen',
      keywords: [],
      responses: ['面白いね！', 'もっと聞かせて！', 'なるほどね。', 'わかった！'],
    },
  ],
  adult: [
    {
...
export function getResponseTemplates(language: Language): Record<IntelligenceTier, ResponseTemplate[]> {
